<?php
    ...
    // you need to use 'composer install predis' in some php working dir.
    // It will install the PHP library to handle predis calls.
    // -- you will need to get 'composer'
    require_once '/var/www/html/vendor/predis/predis/autoload.php';

    $redis = new Predis\Client(['host' => 'php_redis_1']);
